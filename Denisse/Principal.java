...
public class Principal {
	...
	public static void main(String[] args) {
		...
		do {
			...
			case 1:
				...
				break;
			case 2:
				System.out.println("=== Mostrar contenido por categoria ===");
				mostrarPorCategoria(contenidos);
				break;
			case 3:
	...
	private static void mostrarPorCategoria(ArrayList<contenido> contenidos) {
